...
public class BarberCenterController implements Initializable {
    ...
    private static final String BARBER_CENTER_LIST_ITEM = "view_1/client/center_list_item.fxml";

    private static final String ADD_BARBER_CENTER_SCREEN_NAME = "view_1/barber/barber_add_center.fxml";
    private static final String BARBER_MODIFY_SCREEN_NAME = "view_1/barber/barber_modify_center.fxml";
