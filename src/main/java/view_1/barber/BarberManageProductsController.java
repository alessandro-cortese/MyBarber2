...
public class BarberManageProductsController implements Initializable {
    ...
    private static final String LIST_ITEM_RES = "view_1/listitem/client_buy_product_list_item.fxml";
    private static final String MODIFY_PRODUCT_SCREEN_NAME = "view_1/barber/barber_add_product.fxml";
