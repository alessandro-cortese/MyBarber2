...
public class TakeAppointmentClientController {
    ...
    private static final String APPOINTMENT_SALOON_ITEM = "view_1/listitem/take_saloon_item.fxml";
    private static final String CLIENT_TAKE_SALOON_SCREEN_NAME = "view_1/client/client_take_saloon.fxml";
