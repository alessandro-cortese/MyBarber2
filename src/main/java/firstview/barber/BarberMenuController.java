...
import firstview.general.BackController;
...
public class BarberMenuController {
    ...
    private static final String ADD_BARBER_SCREEN_NAME = "firstview/barber/barber_add_center.fxml";
    private static final String BARBER_CENTER_SCREEN_NAME = "firstview/barber/barber_centers.fxml";
    private static final String ADD_SERVICE_BARBER_SCREEN_NAME = "firstview/barber/barber_add_service.fxml";
    private static final String USER_AREA_SCREEN_NAME = "firstview/general/user_area.fxml";
    private static final String BARBER_MANAGE_PRODUCT_SCREEN_NAME = "firstview/barber/barber_manage_products.fxml";
    private static final String BARBER_APPOINTMENTS_LIST_VIEW_SCREEN_NAME = "firstview/barber/barber_appointments.fxml";
