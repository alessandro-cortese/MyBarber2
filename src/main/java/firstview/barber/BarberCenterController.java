...
public class BarberCenterController implements Initializable {
    ...
    private static final String BARBER_CENTER_LIST_ITEM = "firstview/client/center_list_item.fxml";

    private static final String ADD_BARBER_CENTER_SCREEN_NAME = "firstview/barber/barber_add_center.fxml";
    private static final String BARBER_MODIFY_SCREEN_NAME = "firstview/barber/barber_modify_center.fxml";
