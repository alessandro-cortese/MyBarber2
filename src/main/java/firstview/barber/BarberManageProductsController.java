...
public class BarberManageProductsController implements Initializable {
    ...
    private static final String LIST_ITEM_RES = "firstview/listitem/client_buy_product_list_item.fxml";
    private static final String MODIFY_PRODUCT_SCREEN_NAME = "firstview/barber/barber_add_product.fxml";
