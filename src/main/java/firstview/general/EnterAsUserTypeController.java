...
public class EnterAsUserTypeController {
    ...
    public static final String BARBER_HOME_SCREEN = "firstview/barber/barber_home.fxml";
    public static final String CLIENT_HOME_SCREEN = "firstview/client/client_home.fxml";
