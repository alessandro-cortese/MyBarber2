...
public class ClientMenuController {
    ...
    private static final String SEE_APPOINTMENTS_SCREEN_NAME = "firstview/client/client_see_appointments.fxml";
    private static final String BUY_PRODUCT_SCREEN_NAME = "firstview/client/client_buy_product.fxml";
    private static final String CLIENT_CART_SCREEN_NAME = "firstview/client/client_cart.fxml";
    private static final String USER_AREA_SCREEN_NAME = "firstview/general/user_area.fxml";


    private static final String TAKE_APPOINTMENT_SCREEN_NAME = "firstview/client/client_take_appointment.fxml";
